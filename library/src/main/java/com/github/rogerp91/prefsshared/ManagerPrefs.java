package com.github.rogerp91.prefsshared;
...
public class ManagerPrefs {
    ...
    public static SharedPreferences getPreferences() {
        ...
        throw new RuntimeException(
                "ManagerPrefs class not correctly instantiated please call Builder.setContext().build(); in the Application class onCreate.");
    }
    ...
    public final static class Builder {
        ...
        public void build() {
            if (mContext == null) {
                throw new RuntimeException("Context not set, please set context before building the ManagerPrefs instance.");
            }
            ...
            ManagerPrefs.initPrefs(mContext, mKey, mMode);
        }
    }
}
